...
def DFS(InitialState):
    ...
    if(tm>60):
                    with open('solutions/#DFS-Solution-Path.txt', 'w') as f:
                        with redirect_stdout(f): 
                                      print("no solution")
                    with open('solutions/#DFS-Search-Path.txt', 'w') as f:
                         with redirect_stdout(f):
                                       print("no solution")
...
def IterativeDeepenng(InitialState):
    ...
    if(tm>60):
                    with open('solutions/#Iterative-Deepening-Solution-Path.txt', 'w') as f:
                        with redirect_stdout(f): 
                                      print("no solution")
                    with open('solutions/#Iterative-Deepening-Search-Path.txt', 'w') as f:
                         with redirect_stdout(f):
                                       print("no solution")
...
InitialState =  np.array([[6,1,2],[7,8,3] ,[5,4,9]])
print("DFS:")
print("#############")
DFS(InitialState)
print("#############")
